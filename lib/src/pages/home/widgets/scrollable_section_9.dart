...
class _ScrollableSectionNine extends StatelessWidget {
  final List itemCount;
  final String label;
  final VoidCallback onViewAllTap;
  
  const _ScrollableSectionNine({
    Key? key,
  ...
  Future<List<TacoProductModel>> _fetchProduct() async {
    final response = await http
        .get(Uri.parse("https://www.tacoclout.com/category/switch-systems.json"));
