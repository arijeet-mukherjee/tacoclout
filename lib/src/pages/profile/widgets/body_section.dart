      ...
      return Column(
        children: [
          ...
          /* CustomShakeTransition(
            ...
            child: ListTile(
              onTap: () {
                ...
                Get.toNamed(Routes.language, arguments: locale.locale);
              },
          ...
          CustomShakeTransition(
            ...
            child: ListTile(
              onTap: () {
                Get.toNamed(Routes.disclaimer);
              },
              leading: Icon(FeatherIcons.alertCircle, color: theme.primaryColor),
